...
import { getNotificationImpl, sendDemoNotification } from '../api/eventy'
    ...
    <div style={{ maxWidth: 920, margin: '0 auto', padding: '16px 24px' }}>
      ...
      >
        ...
        <p style={{ fontSize: 13, color: '#555' }}>
          ...
          (<code>@Audited</code>) on <code>EventsService</code> only fires for service methods —
          register a participant on an event detail page to see it.
        </p>
      ...
      >
        ...
        <ul style={{ paddingLeft: 18, lineHeight: 1.6 }}>
          <li>
            ...
            <code> EventsService</code> calls; enabled in <code>beans.xml</code> &lt;interceptors&gt;.
          </li>
          <li>
          ...
          <li>
            <strong>locking-demo</strong> — bookkeeping from the optimistic-locking demo.
          </li>
          <li>
